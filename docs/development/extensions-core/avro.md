...
This Apache Druid (incubating) extension enables Druid to ingest and understand the Apache Avro data format. Make sure to [include](../../operations/including-extensions.md) `druid-avro-extensions` as an extension.
...
An Avro parseSpec can contain a [flattenSpec](../../ingestion/flatten-json.md) using either the "root" or "path"
