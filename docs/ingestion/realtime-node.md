...
[Firehose](../ingestion/firehose.md) connected to the data you want to
...
For general Real-time Process information, see [here](../design/realtime.md).

For Real-time Process Configuration, see [Realtime Configuration](../configuration/realtime.md).

For writing your own plugins to the real-time process, see [Firehose](../ingestion/firehose.md).
...
See [Ingestion](../ingestion/index.md)
...
See [Firehose](../ingestion/firehose.md) for more information on various firehoses.
