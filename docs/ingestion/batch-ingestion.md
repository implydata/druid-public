...
Druid has built-in batch ingestion functionality. See [here](../ingestion/native_tasks.md) for more info.

## Hadoop Batch Ingestion

Hadoop can be used for batch ingestion. The Hadoop-based batch ingestion will be faster and more scalable than the native batch ingestion. See [here](../ingestion/hadoop.md) for more details.
