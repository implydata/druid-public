...
For more details, please see the [Deep storage](../dependencies/deep-storage.html) page.
...
For more details, please see the [Metadata storage](../dependencies/metadata-storage.html) page.

### ZooKeeper
Used for internal service discovery, coordination, and leader election.

For more details, please see the [ZooKeeper](../dependencies/zookeeper.html) page.
