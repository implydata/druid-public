...
Note that this is only supported by the non-parallel [Native Batch Task](../ingestion/native_tasks.md), the Hadoop Batch task, and the tasks created by the Kafka Indexing Service.
