...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
    ...
    peg$c52 = function(spacing, functionCall, argument) {
      return {
        type: 'function',
    ...
    peg$c53 = 'distinct',
    peg$c54 = peg$literalExpectation('DISTINCT', true),
    peg$c55 = function(spacing, distinct) {
      return {
        type: 'distinct',
        distinct: distinct,
        spacing: spacing,
    ...
    peg$c56 = function(spacing, distinct, argumentValue) {
      return {
        type: 'argument',
        distinct: distinct,
    ...
    peg$c61 = function(spacing, argument) {
      return {
        type: 'argumentValue',
        spacing: spacing,
    ...
    peg$c64 = function(spacing, quote, value) {
      return {
        type: 'variable',
        value: value.join(''),
        spacing: spacing,
    ...
    peg$c67 = function(spacing, value) {
      return {
        type: 'Constant',
        value: value.join(''),
        spacing: spacing,
    ...
    peg$c70 = function(spacing, value) {
      return {
        type: 'Integer',
        value: value.join(''),
        spacing: spacing,
    ...
    peg$c71 = 'timestamp',
    peg$c72 = peg$literalExpectation('TIMESTAMP', true),
    peg$c73 = /^[0-9" ":\-]/,
    peg$c74 = peg$classExpectation([['0', '9'], '"', ' ', '"', ':', '-'], false, false),
    peg$c75 = function(spacing, timeStamp) {
      return {
        type: 'timestamp',
    ...
    peg$c86 = function(spacing, operator) {
      return {
        type: 'operator',
        spacing: spacing,
        operator: operator,
    ...
    peg$c87 = 'interval',
    peg$c88 = peg$literalExpectation('INTERVAL', true),
    peg$c89 = function(spacing, value, constant) {
      return {
        type: 'interval',
        value: value,
        constant: constant,
    ...
    peg$c92 = function(spacing, syntax, value) {
      return { type: 'alias', value: value, spacing: spacing, syntax: syntax };
    },
    peg$c93 = function(Function) {
      if (functions.includes(Function)) {
        return true;
      } else return false;
    },
    peg$c94 = function(Function) {
      return Function;
    },
    peg$c95 = '>=',
    ...
    peg$c107 = 'between',
    peg$c108 = peg$literalExpectation('BETWEEN', true),
    peg$c109 = 'not between',
    peg$c110 = peg$literalExpectation('NOT BETWEEN', true),
    peg$c111 = 'not like',
    peg$c112 = peg$literalExpectation('NOT LIKE', true),
    peg$c113 = 'like',
    peg$c114 = peg$literalExpectation('LIKE', true),
    peg$c115 = 'is null',
    peg$c116 = peg$literalExpectation('IS NULL', true),
    peg$c117 = 'is not null',
    peg$c118 = peg$literalExpectation('IS NOT NULL', true),
    peg$c119 = 'is true',
    peg$c120 = peg$literalExpectation('IS TRUE', true),
    peg$c121 = 'is not true',
    peg$c122 = peg$literalExpectation('IS NOT TRUE', true),
    peg$c123 = 'is false',
    peg$c124 = peg$literalExpectation('IS FALSE', true),
    peg$c125 = 'in',
    peg$c126 = peg$literalExpectation('IN', true),
    peg$c127 = 'not in',
    peg$c128 = peg$literalExpectation('NOT IN', true),
    peg$c129 = 'or',
    peg$c130 = peg$literalExpectation('OR', true),
    peg$c131 = 'and',
    peg$c132 = peg$literalExpectation('AND', true),
    peg$c133 = 'not',
    peg$c134 = peg$literalExpectation('NOT', true),
    peg$c135 = function(spacing, operator) {
      return {
        type: 'operator',
        operator: operator,
        spacing: spacing,
    ...
    peg$c138 = function(spacing, schema, table, alias) {
      return {
        type: 'table',
    ...
    peg$c154 = /^[a-z_]/i,
    peg$c155 = peg$classExpectation([['a', 'z'], '_'], false, true),
    peg$c156 = function(part) {
      return part.join('');
    },
    peg$currPos = 0,
    peg$savedPos = 0,
                                ...
                                if (s3 === peg$FAILED) {
                                  ...
                                  if (s3 === peg$FAILED) {
                                    ...
                                    if (s3 === peg$FAILED) {
                                      ...
                                      if (s3 === peg$FAILED) {
                                        if (
                                          input.substr(peg$currPos, 2).toLowerCase() === peg$c125
                                        ) {
                                        ...
                                        if (s3 === peg$FAILED) {
                                          if (
                                            input.substr(peg$currPos, 6).toLowerCase() === peg$c127
                                          ) {
