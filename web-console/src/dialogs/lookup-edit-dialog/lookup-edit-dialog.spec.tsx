...
describe('describe lookup edit dialog', () => {
  it('lookup edit dialog snapshot', () => {
    const lookupEditDialog =
      <LookupEditDialog isOpen={false} onClose={() => null} onSubmit={() => null} onChange={() => null} lookupName={'test'} lookupTier={'test'} lookupVersion={'test'} lookupSpec={'test'} isEdit={false} allLookupTiers={['test', 'test']}/>
