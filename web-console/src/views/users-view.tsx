...
export interface UsersViewProps extends React.Props<any> {
...
export class UsersView extends React.Component<UsersViewProps, UsersViewState> {
  ...
  constructor(props: UsersViewProps, context: any) {
    super(props, context);
    this.state = {
      lookups: [],
      loadingLookups: true,
        ...
        columns={[
          {
            ...
            filterable: true,
            show: tableColumnSelectionHandler.showColumn('User name')
          },
          {
            Header: 'Tier',
            id: 'tier',
  ...
  render() {
    ...
    return <div className="users-view app-view">
